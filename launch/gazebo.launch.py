...
def generate_launch_description():
    ...
    urdf_content = load_file("IRB120", "urdf/IRB120.urdf.xml")
    controllers_file = os.path.join(
        get_package_share_directory("IRB120"), "config/IRB120_controller.yaml"
    )
    world = os.path.join(
        get_package_share_directory("IRB120"), "worlds", "IRB120_empty_world.sdf"
    )
